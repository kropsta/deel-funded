      ...
      <header className="border-b border-surface-light px-6 py-4 flex items-center justify-between sticky top-0 bg-bg/90 backdrop-blur z-30">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <span className="text-lg font-bold tracking-tight leading-tight">FundedLead</span>
            <span className="text-xs text-gray-500 leading-tight">Built by Matthew Krop</span>
          </div>
